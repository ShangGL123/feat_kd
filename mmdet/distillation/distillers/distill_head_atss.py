...
class DistillHeadBaseDetector_ATSS(BaseDetector):
    ...
    def __init__(self,
        ...
        super(DistillHeadBaseDetector_ATSS, self).__init__()
    ...
    def loss_distill_head(self, tea_cls_scores, tea_bbox_preds, tea_ious,
        ...
        losses_cls_kd, losses_bbox_kd, losses_iou_kd = multi_apply(
