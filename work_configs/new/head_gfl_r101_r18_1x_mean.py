...
distiller = dict(
    type='DistillHeadBaseDetector_GFL',
    teacher_pretrained = 'work_dirs/gfl_r101_3x_ms/epoch_36.pth',
    init_student = True,
...
student_cfg = 'work_configs/detectors/gfl_r18_1x.py'
teacher_cfg = 'work_configs/detectors/gfl_r101_3x_ms.py'
